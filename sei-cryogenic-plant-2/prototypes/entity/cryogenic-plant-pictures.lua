...
local function cryogenic_plant_animation(name, frames, options)
  ...
  return path_util.sa_sprite_load(
    "__sei-cryogenic-plant-2__/graphics/entity/cryogenic-plant/cryogenic-plant-" .. name,
    options
  )
end
...
return {
  graphics_set = {
    ...
    working_visualisations = {
      ...
      --- anim6
      {
        always_draw = true,
        apply_recipe_tint = "primary",
        animation = cryogenic_plant_animation(
          "anim6-mask1",
          total_frame_count,
          { frame_sequence = anim6_fluid_frame_sequence }
        ),
      },
      {
        effect = "flicker",
        ...
        animation = cryogenic_plant_animation(
          "anim6-working-light",
          total_frame_count,
          { blend_mode = "additive", draw_as_glow = true, frame_sequence = anim6_frame_sequence }
        ),
      },
      ---- smoke
      {
    ...
    frozen_patch = path_util.sa_sprite_load(
      "__sei-cryogenic-plant-2__/graphics/entity/cryogenic-plant/cryogenic-plant-frozen",
      { scale = 0.5 }
    ),
  ...
  pipe_picture = {
    north = {
      layers = {
        path_util.sa_sprite_load(
          "__sei-cryogenic-plant-2__/graphics/entity/cryogenic-plant/cryogenic-plant-pipe-connections-v",
          {
            priority = "extra-high",
            scale = 0.5,
            shift = { 0, 3 },
        ...
        path_util.sa_sprite_load(
          "__sei-cryogenic-plant-2__/graphics/entity/cryogenic-plant/cryogenic-plant-shadow-v",
          {
            priority = "extra-high",
            draw_as_shadow = true,
            scale = 0.5,
    ...
    east = {
      layers = {
        path_util.sa_sprite_load(
          "__sei-cryogenic-plant-2__/graphics/entity/cryogenic-plant/cryogenic-plant-pipe-connections-h",
          {
            priority = "extra-high",
            scale = 0.5,
            shift = { -3, 0 },
        ...
        path_util.sa_sprite_load(
          "__sei-cryogenic-plant-2__/graphics/entity/cryogenic-plant/cryogenic-plant-shadow-h",
          {
            priority = "extra-high",
            draw_as_shadow = true,
            scale = 0.5,
  ...
  pipe_picture_frozen = {
    north = {
      layers = {
        path_util.sa_sprite_load(
          "__sei-cryogenic-plant-2__/graphics/entity/cryogenic-plant/cryogenic-plant-pipe-connections-v-frozen",
          {
            priority = "extra-high",
            scale = 0.5,
            shift = { 0, 3 },
    ...
    east = {
      layers = {
        path_util.sa_sprite_load(
          "__sei-cryogenic-plant-2__/graphics/entity/cryogenic-plant/cryogenic-plant-pipe-connections-h-frozen",
          {
            priority = "extra-high",
            scale = 0.5,
            shift = { -3, 0 },
