if not SEI_SPOILAGE_ENABLED then
  return
end
...
data:extend({
  ...
  },
  {
    ...
    icons = data_util.sub_icons(
      data.raw.item["se-vitamelange-nugget"].icon,
      "__sei-library-2__/graphics/icons/spoilage.png"
    ),
...
bio_sludge_from_spoilage_recipe.localised_description =
  data.raw["recipe"]["se-bio-sludge-from-wood"].localised_description
