  ...
  return {
    {
      ...
      animation = path_util.sa_sprite_load("__sei-gleba-fruits-2__/graphics/sticker/jellynut-speed/whirl_front", {
        priority = "high",
        frame_count = 50,
        scale = 0.5,
        animation_speed = 0.5,
    ...
    },
    {
      ...
      animation = path_util.sa_sprite_load("__sei-gleba-fruits-2__/graphics/sticker/jellynut-speed/whirl_back", {
        priority = "high",
        frame_count = 50,
        scale = 0.5,
        animation_speed = 0.5,
...

    {
      ...
      animation = path_util.sa_sprite_load("__sei-gleba-fruits-2__/graphics/sticker/yumako-regen/regen-front", {
        priority = "high",
        frame_count = 50,
        scale = 0.5,
        draw_as_glow = true,
    ...
    },
    {
      ...
      animation = {
        layers = {
          path_util.sa_sprite_load("__sei-gleba-fruits-2__/graphics/sticker/yumako-regen/regen-ground", {
            priority = "high",
            frame_count = 50,
            scale = 0.5,
            draw_as_glow = true,
          }),
          path_util.sa_sprite_load("__sei-gleba-fruits-2__/graphics/sticker/yumako-regen/regen", {
            priority = "high",
            frame_count = 50,
            scale = 0.5,
            draw_as_glow = true,
...

    {
      ...
      animation = {
        layers = {
          path_util.sa_sprite_load("__sei-gleba-fruits-2__/graphics/sticker/yumako-regen/regen-front", {
            priority = "high",
            frame_count = 50,
            scale = 0.5,
            draw_as_glow = true,
          }),
          path_util.sa_sprite_load("__sei-gleba-fruits-2__/graphics/sticker/jellynut-speed/whirl_front", {
            priority = "high",
            frame_count = 50,
            scale = 0.5,
            animation_speed = 0.5,
    ...
    },
    {
      ...
      animation = {
        layers = {
          ...
          path_util.sa_sprite_load("__sei-gleba-fruits-2__/graphics/sticker/jellynut-speed/whirl_back", {
            priority = "high",
            frame_count = 50,
            scale = 0.5,
            animation_speed = 0.5,
