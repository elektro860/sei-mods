...
walking_sounds_semi_wet = {
    variations = path_util.sa_sound_variations("__sei-gleba-fruits-2__/sound/walking/semi-wet-rock", 10, 0.7),
    advanced_volume_control = default_tile_sounds_advanced_volume_control(),
}

local landing_sounds_semi_wet = {
    variations = path_util.sa_sound_variations("__sei-gleba-fruits-2__/sound/entity/mech-armor/mech-armor-land-semi-wet", 3, 1.0, volume_multiplier("main-menu", 2.9)),
    advanced_volume_control = default_tile_sounds_advanced_volume_control(),
}
...
data:extend({
    {
        ...
        "__sei-gleba-fruits-2__/graphics/terrain/artificial-yumako-soil.png",
        "__sei-gleba-fruits-2__/graphics/terrain/effect-maps/water-gleba-mask.png",
        {
            max_size = 4,
    ...
    },
    {
        ...
        sprite_usage_surface = "any",
        variants = tile_variations_template_with_transitions_and_effect_map(
        "__sei-gleba-fruits-2__/graphics/terrain/overgrowth-yumako-soil.png",
        "__sei-gleba-fruits-2__/graphics/terrain/effect-maps/water-gleba-mask.png",
        {
            max_size = 4,
            [1] = { weights = {0.085, 0.085, 0.085, 0.085, 0.087, 0.085, 0.065, 0.085, 0.045, 0.045, 0.045, 0.045, 0.005, 0.025, 0.045, 0.045 } },
    ...
    },
    {
        ...
        "__sei-gleba-fruits-2__/graphics/terrain/artificial-jellynut-soil.png",
        {
            max_size = 4,
            [1] = { weights = {0.085, 0.085, 0.085, 0.085, 0.087, 0.085, 0.065, 0.085, 0.045, 0.045, 0.045, 0.045, 0.005, 0.025, 0.045, 0.045 } },
            [2] = { probability = 1, weights = {0.018, 0.020, 0.015, 0.025, 0.015, 0.020, 0.025, 0.015, 0.025, 0.025, 0.010, 0.025, 0.020, 0.025, 0.025, 0.010 }, },
    ...
    },
    {
        ...
        sprite_usage_surface = "any",
        variants = tile_variations_template_with_transitions(
        "__sei-gleba-fruits-2__/graphics/terrain/overgrowth-jellynut-soil.png",
        {
            max_size = 4,
            [1] = { weights = {0.085, 0.085, 0.085, 0.085, 0.087, 0.085, 0.065, 0.085, 0.045, 0.045, 0.045, 0.045, 0.005, 0.025, 0.045, 0.045 } },
            [2] = { probability = 1, weights = {0.018, 0.020, 0.015, 0.025, 0.015, 0.020, 0.025, 0.015, 0.025, 0.025, 0.010, 0.025, 0.020, 0.025, 0.025, 0.010 }, },
