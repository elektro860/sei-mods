...
data:extend({
  ...
  },
  {
    ...
    icons = data_util.sub_icons(
      "__sei-gleba-fruits-2__/graphics/icons/yumako-mash.png",
      data.raw["fluid"]["se-vitalic-acid"]
    ),
  ...
  },
  {
    ...
    icons = data_util.sub_icons(
      "__sei-gleba-fruits-2__/graphics/icons/jelly.png",
      data.raw["fluid"]["se-vitalic-acid"]
    ),
    categories = { "crafting-with-fluid", "organic" },
    subgroup = "agriculture-products",
  ...
  },
  {
    ...
    icons = data_util.transition_icons({
      ...
      icon_size = data.raw["capsule"]["jelly"].icon_size,
      scale = 0.5,
    }, {
