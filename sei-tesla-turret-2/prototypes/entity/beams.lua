...
function make_tesla_beam(name, sound, damage, token)
  return {
    ...
    working_sound = sound and {
      sound = {
        category = "weapon",
        filename = "__sei-tesla-turret-2__/sound/entity/tesla-turret/tesla-turret-beam.ogg",
        volume = 1.0,
      },
...
function make_tesla_beam_chain(name, sound, damage, token)
  return {
    ...
    working_sound = sound and {
      sound = {
        category = "weapon",
        filename = "__sei-tesla-turret-2__/sound/entity/tesla-turret/tesla-turret-chain-beam.ogg",
        volume = 0.8,
      },
      max_sounds_per_prototype = 4,
    } or nil,
