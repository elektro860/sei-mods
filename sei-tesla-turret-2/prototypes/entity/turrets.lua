  ...
  return {
    layers = {
      ...
      path_util.sa_sprite_load(
        "__sei-tesla-turret-2__/graphics/entity/tesla-turret/tesla-turret-head-attacking-mask",
        {
          flags = { "mask" },
          apply_runtime_tint = true,
          direction_count = 64,
      ...
      path_util.sa_sprite_load(
        "__sei-tesla-turret-2__/graphics/entity/tesla-turret/tesla-turret-head-attacking-emit",
        {
          direction_count = 64,
          frame_count = 1,
          repeat_count = 30,
      ...
      path_util.sa_sprite_load(
        "__sei-tesla-turret-2__/graphics/entity/tesla-turret/tesla-turret-head-attacking-shadow",
        {
          draw_as_shadow = true,
          direction_count = 64,
          frame_count = 1,
...
local function tesla_turret_cooldown(inputs)
  return {
    layers = {
      ...
      path_util.sa_sprite_load(
        "__sei-tesla-turret-2__/graphics/entity/tesla-turret/tesla-turret-head-attacking-facelight",
        {
          direction_count = 64,
          frame_count = 1,
          repeat_count = 30,
      ...
      base_visualisation = {
        {
          animation = {
            layers = {
              ...
              path_util.sa_sprite_load(
                "__sei-tesla-turret-2__/graphics/entity/tesla-turret/tesla-turret-base-shadow",
                {
                  frame_count = 1,
                  repeat_count = 30,
                  draw_as_shadow = true,
        ...
        },
        {
          ...
          animation = {
            layers = {
              path_util.sa_sprite_load(
                "__sei-tesla-turret-2__/graphics/entity/tesla-turret/tesla-turret-sfx-passive",
                {
                  frame_count = 30,
                  shift = util.by_pixel(0, 0 + tesla_turret_shift),
                  scale = 0.5,
