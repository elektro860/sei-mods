...
data:extend({
  {
    ...
    graphics_set = {
      animation = {
        layers = {
          util.sprite_load("__sei-agricultural-tower-2__/graphics/entity/agricultural-tower/agricultural-tower-base", {
            priority = "high",
            frame_count = 1,
            repeat_count = 64,
            scale = 0.5,
          }),
          util.sprite_load("__sei-agricultural-tower-2__/graphics/entity/agricultural-tower/agricultural-tower-anim", {
            priority = "high",
