...
data:extend({
  ...
  },
  {
    ...
    pictures = {
      {
        size = 64,
        filename = "__sei-agricultural-tower-2__/graphics/icons/tree-seed-1.png",
        scale = 0.5,
        mipmap_count = 4,
      },
      {
        size = 64,
        filename = "__sei-agricultural-tower-2__/graphics/icons/tree-seed-2.png",
        scale = 0.5,
        mipmap_count = 4,
      },
      {
        size = 64,
        filename = "__sei-agricultural-tower-2__/graphics/icons/tree-seed-3.png",
        scale = 0.5,
        mipmap_count = 4,
      },
      {
        size = 64,
        filename = "__sei-agricultural-tower-2__/graphics/icons/tree-seed-4.png",
        scale = 0.5,
        mipmap_count = 4,
      },
    },
