...
local function reactor_connection_pictures(num, plasma_uv_shift)
  local shadow = nil
  if num < 7 then
    shadow = path_util.sa_sprite_load(
      "__sei-fusion-reactor-2__/graphics/entity/fusion-reactor/fusion-reactor-connection-" .. num .. "-shadow",
      {
        priority = "high",
        draw_as_shadow = true,
        scale = 0.5,
  ...
  return {
    pictures = {
      layers = {
        path_util.sa_sprite_load(
          "__sei-fusion-reactor-2__/graphics/entity/fusion-reactor/fusion-reactor-connection-" .. num,
          {
            priority = "high",
            scale = 0.5,
            frame_count = 5,
    ...
    working_light_pictures = {
      layers = {
        path_util.sa_sprite_load(
          "__sei-fusion-reactor-2__/graphics/entity/fusion-reactor/fusion-reactor-connection-" .. num .. "-glow",
          {
            priority = "high",
            blend_mode = "additive",
            draw_as_glow = true,
    ...
    fusion_effect_uv_map = {
      filename = "__sei-fusion-reactor-2__/graphics/entity/fusion-reactor/fusion-reactor-connection-"
        .. num
        .. "-plasma-UV.png",
      width = 64,
      height = 64,
...
local function generator_pictures(direction)
  return {
    layers = {
      path_util.sa_sprite_load(
        "__sei-fusion-reactor-2__/graphics/entity/fusion-generator/" .. direction .. "/fusion-generator-" .. direction,
        {
          priority = "high",
          frame_count = 6,
          scale = 0.5,
      ...
      path_util.sa_sprite_load(
        "__sei-fusion-reactor-2__/graphics/entity/fusion-generator/"
          .. direction
          .. "/fusion-generator-"
          .. direction
          .. "-shadow",
...
local function generator_working_light(direction, fluid_input)
  ...
  local sprite = path_util.sa_sprite_load(
    "__sei-fusion-reactor-2__/graphics/entity/fusion-generator/"
      .. direction
      .. "/fusion-generator-"
      .. direction
...
local function generator_uv_map(direction, shift, fluid_input)
  ...
  shift = shift or { 0, 0 }
  return path_util.sa_sprite_load(
    "__sei-fusion-reactor-2__/graphics/entity/fusion-generator/"
      .. direction
      .. "/fusion-generator-"
      .. direction
