...
data:extend({
  ...
  },
  {
    ...
    neighbour_connectable = {
      connections = {
        {
          location = { position = { -1.5, -3 }, direction = defines.direction.north },
          category = "fusion-reactor-plasma",
          neighbour_category = { "fusion-reactor-plasma", "fusion-reactor-coolant" },
        },
        {
          location = { position = { 1.5, -3 }, direction = defines.direction.north },
          category = "fusion-reactor-plasma",
        ...
        {
          location = { position = { 3, -1.5 }, direction = defines.direction.east },
        ...
        {
          location = { position = { 1.5, 3 }, direction = defines.direction.south },
          category = "fusion-reactor-plasma",
          neighbour_category = { "fusion-reactor-plasma", "fusion-reactor-coolant" },
        },
        {
        ...
        {
          location = { position = { -3, 1.5 }, direction = defines.direction.west },
          category = "fusion-reactor-coolant",
          neighbour_category = { "fusion-reactor-plasma", "fusion-reactor-coolant" },
        },
        {
    ...
    working_sound = {
      sound = {
        filename = "__sei-fusion-reactor-2__/sound/entity/fusion/fusion-reactor.ogg",
        volume = 0.6,
