...
data:extend({
  {
    ...
    animation = path_util.sa_sprite_load(
      "__sei-fusion-reactor-2__/graphics/entity/fusion-reactor/fusion-reactor-remnants",
      {
        scale = 0.5,
        direction_count = 1,
      }
  ...
  },
  {
    ...
    remove_on_tile_placement = false,
    animation = path_util.sa_sprite_load(
      "__sei-fusion-reactor-2__/graphics/entity/fusion-generator/fusion-generator-remnants",
      {
        scale = 0.5,
        direction_count = 4,
      }
