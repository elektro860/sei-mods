...
data:extend({
  {
    ...
    results = { { type = "item", reset_freshness_on_craft = true, name = "captive-biter-spawner", amount = 1 } },
    enabled = false,
  },
  {
    type = "recipe",
...
data_util.make_recipe({
  ...
  icons = data_util.sub_icons(data.raw.fluid["se-nutrient-gel"].icon, data.raw.item["biter-egg"].icon),
