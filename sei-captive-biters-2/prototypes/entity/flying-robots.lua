...
robot_animations.capture = {
  layers = {
    path_util.sa_sprite_load(
      "__sei-captive-biters-2__/graphics/entity/capture-robot-rocket/capture-robot-capture-anim",
      {
    ...
    path_util.sa_sprite_load(
      "__sei-captive-biters-2__/graphics/entity/capture-robot-rocket/capture-robot-capture-anim-mask",
      {
        animation_speed = 0.25,
        frame_count = 32,
        scale = 0.5,
    ...
    path_util.sa_sprite_load(
      "__sei-captive-biters-2__/graphics/entity/capture-robot-rocket/capture-robot-capture-anim-shadow",
      {
        animation_speed = 0.25,
        frame_count = 32,
        scale = 0.5,
...
local make_robot_particle = function(prototype)
  ...
  if not prototype.in_motion then
    return
  end
  local animation = adjust_animation(prototype.in_motion)
  if not prototype.shadow_in_motion then
    return
  end
