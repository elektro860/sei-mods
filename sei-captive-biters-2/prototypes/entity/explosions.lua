...
data:extend({
  {
    ...
    animations = path_util.sa_sprite_load(
      "__sei-captive-biters-2__/graphics/entity/captive-spawner/captive-explosion-1",
      {
        animation_speed = 0.3,
        scale = 0.5,
        frame_count = 8,
  ...
  },
  {
    ...
    smoke_slow_down_factor = 1,
    animations = path_util.sa_sprite_load(
      "__sei-captive-biters-2__/graphics/entity/captive-spawner/captive-explosion-2",
      {
        animation_speed = 0.3,
        scale = 0.5,
        frame_count = 8,
