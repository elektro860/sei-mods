      ...
      working_visualisations = {
        {
          ...
          animation = path_util.sa_sprite_load(
            "__sei-captive-biters-2__/graphics/entity/captive-spawner/captive-fluids",
            {
              frame_count = 32,
              scale = 0.5,
              tint = { 0.25, 0.44, 0, 1 },
      ...
      sound_accents = {
        {
          sound = {
            variations = path_util.sa_sound_variations(
              "__sei-captive-biters-2__/sound/entity/spawner/spawner-respirator-push",
              3,
              0.3
            ),
        ...
        },
        {
          sound = {
            variations = path_util.sa_sound_variations(
              "__sei-captive-biters-2__/sound/entity/spawner/spawner-respirator-pull",
              3,
              0.3
            ),
            audible_distance_modifier = 0.6,
