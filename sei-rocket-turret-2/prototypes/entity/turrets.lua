...
data:extend({
  {
    ...
    preparing_sound = {
      variations = path_util.sa_sound_variations(
        "__sei-rocket-turret-2__/sound/entity/rocket-turret/rocket-turret-activate",
        2,
        0.4
      ),
    ...
    folding_sound = {
      variations = path_util.sa_sound_variations(
        "__sei-rocket-turret-2__/sound/entity/rocket-turret/rocket-turret-deactivate",
        2,
        0.5
      ),
      aggregation = { max_count = 2, remove = true, count_already_playing = true },
    ...
    rotating_sound = {
      sound = {
        variations = {
          filename = "__sei-rocket-turret-2__/sound/entity/rocket-turret/rocket-turret-rotation-loop.ogg",
          volume = 0.15,
        },
        aggregation = { max_count = 2, remove = true, count_already_playing = true },
      },
      stopped_sound = {
        variations = {
          filename = "__sei-rocket-turret-2__/sound/entity/rocket-turret/rocket-turret-rotation-stop.ogg",
          volume = 0.5,
        },
        ...
        animation = {
          layers = {
            ...
            path_util.sa_sprite_load(
              "__sei-rocket-turret-2__/graphics/entity/rocket-turret/rocket-turret-base-shadow",
              {
                frame_count = 1,
                scale = 0.5,
                shift = util.by_pixel(0.0, 0.0 + rocket_turret_shift),
    ...
    attack_parameters = {
      ...
      sound = {
        variations = path_util.sa_sound_variations(
          "__sei-rocket-turret-2__/sound/ammo/rocket-turret-launcher",
          7,
          0.7,
