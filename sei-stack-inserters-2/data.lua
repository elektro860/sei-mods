...
data.raw.technology["transport-belt-capacity-2"].prerequisites =
  { "se-biological-science-pack-4", "transport-belt-capacity-1" }
...
data.raw["mining-drill"]["electric-mining-drill"].drops_full_belt_stacks =
  settings.startup["sei-add-stacking-to-electric-mining-drill"].value
data.raw["mining-drill"]["area-mining-drill"].drops_full_belt_stacks =
  settings.startup["sei-add-stacking-to-area-mining-drill"].value
