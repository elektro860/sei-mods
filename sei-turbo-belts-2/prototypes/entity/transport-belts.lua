...
data:extend({
  ...
  },
  {
    ...
    structure_patch = {
      ...
      east = util.sprite_load("__sei-turbo-belts-2__/graphics/entity/turbo-splitter/turbo-splitter-east-top_patch", {
        frame_count = 32,
        priority = "extra-high",
        scale = 0.5,
      }),
      south = util.empty_sprite(),
      west = util.sprite_load("__sei-turbo-belts-2__/graphics/entity/turbo-splitter/turbo-splitter-west-top_patch", {
        frame_count = 32,
        priority = "extra-high",
        scale = 0.5,
      }),
